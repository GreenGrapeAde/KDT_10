...
## ----------------------------------------------------------
##-> Series로 변환 저장 (하나의 칼럼)
## ----------------------------------------------------------
##-> data, index
dataSR1 = pd.Series(jumsu, idx)                          ## 인덱스 지정
print(dataSR1)

##-> data, index, dtype
dataSR2 = pd.Series(jumsu, idx, dtype=pd.Int8Dtype())    ## IntegerArray, pandas 내부에서 쓰이는 형태
print(dataSR2)

##-> data, index, dtype
dataSR3 = pd.Series(jumsu, idx, dtype='int8')            ## dtype 지정
print(dataSR3)

dataSR4 = pd.Series(jumsu, idx, dtype='int8', name='jumsu') ## Series name 같이 출력
print(dataSR4)
## ----------------------------------------------------------
##-> Series 인스턴스의 속성 읽기
## ----------------------------------------------------------
