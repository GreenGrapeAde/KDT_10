...
b1.pack(side="left")                         # text가 보일 만큼의 너비 구성
b1_1.pack(side="left", fill="x")             # side='top'인 경우 가로(x축) 공간만 확장 가능해서 fill="x"를 함

b2.pack(side="left")
b2_1.pack(side="left", anchor="e")        # 동쪽

b3.pack(side="left")
b3_1.pack(side="left", fill="y")

b4.pack(side="left")
b4_1.pack(side="left", anchor="s")         # 나의 할당된 공간 안에서 배치. 중간으로 배치하고 싶다면 anchor 빼기!
