...
b4.grid(row=1, column=0, rowspan=2)        # 행 간격 2개를 만들어서 가운데에 들어감
b5.grid(row=1, column=1, columnspan=3)     # 열 간격 3개를 만들어서 가운데에 들어감 + b2의 넓힌 너비를 따라감
b6.grid(row=1, column=3)

b70.grid(row=2, column=0)
b7.grid(row=2, column=1, sticky="w")       # west에 sticky
